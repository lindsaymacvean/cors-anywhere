...
function withCORS(headers, request) {
  ...
  console.log('These are the PROXY response headers coming back for '+request.url+' ... '+output+'\n');
...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  withCORS(proxyRes.headers, req)
    .then(() => {
      ...
      console.log('These are the FINAL response headers coming back for '+request.url+' ... '+output+'\n');
    })
  return true;
}
