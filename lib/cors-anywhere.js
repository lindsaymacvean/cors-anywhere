...
function withCORS(headers, request) {
  ...
  //   console.log('Added cookie '+request.headers['cookie']+' to response for request '+request.url);
  // }
...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  var output = '';
  for (var property in proxyRes.headers) {
    output += property + ': ' + proxyRes.headers[property]+'; ';
  }
  console.log('These are the response headers comping back for '+req.url+' ... '+output);
  ...
  console.log(proxyRes.url+' response had a cookie: '+proxyRes.headers['set-cookie']);
